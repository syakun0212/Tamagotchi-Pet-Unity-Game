...
public class LeaderboardTest
{
    ...
    public IEnumerator post_assignmt_all_ui_components_check()
    {
        SceneManager.LoadScene("PostAssignment-1");
    ...
    public IEnumerator post_assignmt_qn_data_view_rows_check()
    {
        SceneManager.LoadScene("PostAssignment-1");
        yield return new WaitForSeconds(3);
        // Check page one
    ...
    public IEnumerator post_assignmt_qn_data_view_headers_check()
    {
        SceneManager.LoadScene("PostAssignment-1");
        yield return new WaitForSeconds(3);
        // Check page one
    ...
    public IEnumerator post_assignmt_qn_data_view_next_page_button_check()
    {
        SceneManager.LoadScene("PostAssignment-1");
        yield return new WaitForSeconds(3);
    ...
    public IEnumerator post_assignmt_qn_data_view_prev_page_button_check()
    {
        SceneManager.LoadScene("PostAssignment-1");
        yield return new WaitForSeconds(3);
    ...
    public IEnumerator post_assignmt_qn_data_view_add_button_check()
    {
        SceneManager.LoadScene("PostAssignment-1");
        yield return new WaitForSeconds(3);
    ...
    public IEnumerator post_assignmt_added_qn_view_delete_button_check()
    {
        SceneManager.LoadScene("PostAssignment-1");
        yield return new WaitForSeconds(3);
    ...
    public IEnumerator post_assignmt_added_qn_view_prev_page_check()
    {
        SceneManager.LoadScene("PostAssignment-1");
        yield return new WaitForSeconds(3);
    ...
    public IEnumerator post_assignmt_added_qn_view_prev_page_check()
    {
        ...
        Assert.IsTrue(rowThreeId >= rowFourId);
          ...
          public IEnumerator post_assignmt_input_description_text_check()
    {
        SceneManager.LoadScene("PostAssignment-1");
        yield return new WaitForSeconds(3);
    ...
    public IEnumerator post_assignmt_added_qn_view_rows_check()
    {
        SceneManager.LoadScene("PostAssignment-1");
        yield return new WaitForSeconds(3);
        // Check page one
